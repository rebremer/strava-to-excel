...
- Finally, run `python strava_activities_csv.py` that will download all your activities to a new csv file strava_activities_csv.csv that can be opened in Excel (see screenshot below)
